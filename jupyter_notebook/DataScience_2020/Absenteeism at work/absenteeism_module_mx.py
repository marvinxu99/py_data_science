...
# model_file = 'model'
# scaler_file = 'scaler'
# absenteeism_model = absenteeism_model(model_file, scaler_file)


# In[3]:


# absenteeism_model.load_and_clean_data('Absenteeism_new_data.csv')


# In[4]:


# absenteeism_model.predicted_probability()


# In[5]:


# absenteeism_model.predicted_output_category()


# In[6]:


# absenteeism_model.predicted_outputs()
